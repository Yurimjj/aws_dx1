...
const fileuploadRouter = require("./routes/UploadRout");   // 파일업로드
...
app.use(express.static("./uploads"));       //  (1) 정적폴더지정
// 이미지 경로 정적 제공
app.use('/image', express.static(path.join(__dirname, 'uploads/image')));    //(2)
app.use('/swmanual', express.static(path.join(__dirname, 'uploads/swmanual'))); //(2)
